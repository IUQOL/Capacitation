...
use SsCenter\MainBundle\Entity\ContactForm;
use SsCenter\MainBundle\Form\ContactFormType;
...
class ContactFormController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SsCenterMainBundle:ContactForm')->findAll();

        return $this->render('SsCenterMainBundle:ContactForm:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SsCenterMainBundle:ContactForm:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SsCenterMainBundle:ContactForm')->find($id);
        ...
        return $this->render('SsCenterMainBundle:ContactForm:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SsCenterMainBundle:ContactForm:edit.html.twig', array(
            'entity'      => $entity,
